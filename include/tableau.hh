...
namespace tableau{
    ...
    const double a[6][order] = {{0,0,0,0,0},
                      {1./5.,0,0,0,0},
                      {3./40., 9./40., 0,0,0},
    ...
    const double b[6] = {35./384., 0., 500./1113., 125./192., -2187./6784., 11./84.};

    const double c[7] = {0.,1./5.,3./10.,4./5.,8./9.,1.,1.};

    const double e[7] = {-71./57600., 0., 71./16695.,-71./1920., 17253./339200.,-22./525., 1./40.};

    const double p[7][4] = {{1.,-8048581381./2820520608., 8663915743./2820520608.,-12715105075./11282082432.},
                      {0., 0., 0., 0.},
