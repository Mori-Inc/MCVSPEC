...
void tbnew(const double *ear, int ne, const double *param, int ifl, double *photar,
  ...
  if (startup) {
    ...
    fprintf(stdout,"tbvabs Version 2.3\n");
    fprintf(stdout,"Cosmic absorption with grains and H2, modified from\n");
    fprintf(stdout,"Wilms, Allen, & McCray, 2000, ApJ 542, 914-924\n");
    fprintf(stdout,"Questions: Joern Wilms\n");
    fprintf(stdout,"joern.wilms@sternwarte.uni-erlangen.de\n");
    fprintf(stdout,"joern.wilms@fau.de\n\n");
    fprintf(stdout,"http://pulsar.sternwarte.uni-erlangen.de/wilms/research/tbabs/\n\n");
    fprintf(stdout,"PLEASE NOTICE:\n");
    fprintf(stdout,"To get the model described by the above paper\n");
    fprintf(stdout,"you will also have to set the abundances:\n");
    fprintf(stdout,"   abund wilm\n\n");
    fprintf(stdout,"Note that this routine ignores the current cross section setting\n");
    fprintf(stdout,"as it always HAS to use the Verner cross sections as a baseline.\n");
    startup=0;
  }
