...
c**************************************************************************
     ...
     &              fgmodf
      ...
      datdir = fgmodf()
      Filion = TRIM(datdir)//'ionis.fits'
      Filrec = TRIM(datdir)//'recomb.fits'
      Filrem = TRIM(datdir)//'recombm.fits'
      Fillin = TRIM(datdir)//'linefile.fits'
      Filjac = TRIM(datdir)//'ionjac.fits'
      Filras = TRIM(datdir)//'ionras.fits'
      Filspe = TRIM(datdir)//'conemx.fits'
      Filkar = TRIM(datdir)//'karlat.fits'
      Filcaf = TRIM(datdir)//'cafelines.fits'
      RETURN
      END
...
c************************************************************************
C*** Start of declarations inserted by SPAG
      REAL a31 , a32 , bf , CMAX , dgfbk , dx , E1 , E2 , e2p , 
...
c ----------------------------------------------------------------------
      ...
      IF (ierr .NE. 0) THEN
         context = 'Failed to open '//TRIM(Filrec)
         GOTO 10
      ENDIF
...
c ----------------------------------------------------------------------
      ...
      context = 'Failed to open '//TRIM(Fillin)
