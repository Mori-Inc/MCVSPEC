...
class FunctionUtility 
{
  ...
  public:
      ...
      static void tableInterpolate(const RealArray& energyArray, const RealArray& params,
			    const string fileName, RealArray& fluxArray,
			    RealArray& fluxErrArray, const string initString,
			    const string tableType, const bool readFull,
			    const std::map<string,Real>& spectrumXFLT=std::map<string,Real>());
      static void tableInterpolate(const RealArray& energyArray, const RealArray& params,
				   const string fileName, int spectrumNumber, RealArray& fluxArray,
			    RealArray& fluxErrArray, const string initString,
				   const string tableType, const bool readFull);
      static int tableInfo(const string fileName, int& numberParams, int& numberSpectra,
			   int& numberEnergies, bool& isAdditive, bool& isRedshift, bool& isEscale);
